...
[![Travis build status](https://travis-ci.org/umccr/covis.svg?branch=master)](https://travis-ci.org/umccr/covis)
[![Coverage status](https://codecov.io/gh/umccr/covis/branch/master/graph/badge.svg)](https://codecov.io/github/umccr/covis?branch=master)
...
You can install the development version of `covis` from [GitHub](https://github.com/umccr/covis) with:
